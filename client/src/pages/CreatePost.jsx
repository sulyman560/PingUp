  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        {/* Title */}
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-slate-600 mb-2'>Create Post</h1>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          {/* Text Area */}
          <textarea className="w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400" placeholder= "Whats's happening?" 
          onChange={(e)=>setContent(e.target.value)} value={content} id="" />
          {/* Images */}
          {
