  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        {/* Title */}
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-slate-600 mb-2'>Connections</h1>
          <p className='text-slate-600'>Manage your network & discover new connections</p>
        </div>
        {/* Counts */}
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  ...
                  }
                  {
                    currentTab === 'Connections' && (
                      <button onClick={()=> navigate(`/messages/${user._id}`)} className='w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition 
